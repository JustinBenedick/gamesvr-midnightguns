...
#####################################################################################################
### CONFIG VARS #####################################################################################
declare LLTEST_CMD="/app/midnightguns  -server -protocol MIDNIGHT +sv_port 27501 +map harlem +set hostname "Hostname" +sv_public 1 +exec test.cfg";
...
should_have 'test.cfg has started' 'test config file launched';
should_have 'test.cfg has been completed''test config file finished';
